  ...
  const { choice } = await prompt([
    {
      ...
      choices: [
        ...
        {
          name: "Remove Employee(s)",
          value: "REMOVE_EMPLOYEE"
        },
        {
          name: "Update Employee Role(s)",
  ...
  const { managerId } = await prompt([
    {
      type: "list",
      name: "managerId",
      message: "Which employee do you wish to see direct reports for?",
  ...
  const { managerId } = await prompt([
    {
      ...
      name: "managerId",
      message:
        "Who do you wish to set as selected employee's manager?",
      choices: managerChoices
    }
  ]);
  ...
  const { roleId } = await prompt([
    {
      ...
      name: "roleId",
      message:
        "Select a role to remove (Warning: This will also remove all employees with this role)",
      choices: roleChoices
    }
  ]);
...
async function addDepartment() {
  const department = await prompt([
    {
      name: "name",
      message: "Please enter the name of the department now"
    }
  ]);
...
async function removeDepartment() {
  ...
  const { departmentId } = await prompt({
    ...
    name: "departmentId",
    message:
      "Select department to remove (Warning: This will remove all assigned roles and employees)",
    choices: departmentChoices
  });
...
async function addEmployee() {
  ...
  console.log(
    `${employee.first_name} ${employee.last_name} has been added to the database`
  );
  loadMainPrompts();
}
function quit() {
